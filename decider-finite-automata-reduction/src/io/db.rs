...
use super::MachineID;
use crate::core::{Machine, SYMBOLS, TM_STATES};
use std::fs::File;
...
const RECORD_SIZE: i64 = (3 * SYMBOLS * TM_STATES) as i64;
...
impl Database {
    ...
    pub fn read<'a, I: Iterator<Item = MachineID> + 'a>(
        ...
        Reader { reader, ids, bytes: [0u8; 3 * SYMBOLS * TM_STATES], pos }
    }
